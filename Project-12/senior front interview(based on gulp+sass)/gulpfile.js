...
//处理scss编译
var src='origin/sass/*scss';  //源文件路径
...
gulp.task('minify-css', function() {
  return gulp.src('origin/css/*.css')       //源文件路径
...
gulp.task('minifyjs', function() {
    return gulp.src('origin/js/*.js')       //源文件路径
...
gulp.task('default', ['styles','minify-css','minifyjs','watch']);  //最终执行
